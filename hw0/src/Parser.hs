...
happyExpList = Happy_Data_Array.listArray (0,35) ([11264,5632,64,16,0,352,176,0,32768,1,32779,5,1,45056,0,0,0,32,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseLogic","Expression","Disjunction","Conjunction","Negation","'&'","'|'","'->'","'!'","'('","')'","VAR","%eof"]
        bit_start = st * 15
        bit_end = (st + 1) * 15
...
happyReduction_2 (HappyAbsSyn4  happy_var_3)
	...
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn4
		 (Binary To happy_var_1 happy_var_3
	)
...
parseLogic tks = happySomeParser where
...
{-# LINE 7 "<command-line>" #-}
{-# LINE 1 "/home/haze/.stack/programs/x86_64-linux/ghc-tinfo6-8.6.3/lib/ghc-8.6.3/include/ghcversion.h" #-}
