...
happyExpList = Happy_Data_Array.listArray (0,35) ([11264,5632,128,32,0,352,176,0,0,0,32779,5,1,45056,0,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_expr","Expr","Disj","Conj","Neg","'->'","'&'","'|'","'!'","'('","')'","VAR","%eof"]
        bit_start = st * 15
        bit_end = (st + 1) * 15
